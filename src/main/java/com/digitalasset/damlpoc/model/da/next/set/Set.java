...
public class Set<a> {
  ...
  public Record toValue() {
    ...
    fields.add(new Record.Field("textMap", new DamlMap(this.textMap.entrySet().stream().collect(Collectors.<Map.Entry<String,com.daml.ledger.javaapi.data.Unit>,String,Value>toMap(Map.Entry::getKey, v$0 -> Unit.getInstance())))));
