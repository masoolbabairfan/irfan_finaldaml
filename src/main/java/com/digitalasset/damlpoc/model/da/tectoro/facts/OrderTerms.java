...
public class OrderTerms {
  ...
  public OrderTerms(String operation, String securityId, String orderId, BigDecimal qty,
      BigDecimal price, String exchange, String regulator, LocalDate tradeDate) {
  ...
  public static OrderTerms fromValue(Value value$) throws IllegalArgumentException {
    ...
    BigDecimal qty = fields$.get(3).getValue().asDecimal().orElseThrow(() -> new IllegalArgumentException("Expected qty to be of type com.daml.ledger.javaapi.data.Decimal")).getValue();
  ...
  public Record toValue() {
    ...
    fields.add(new Record.Field("qty", new Decimal(this.qty)));
