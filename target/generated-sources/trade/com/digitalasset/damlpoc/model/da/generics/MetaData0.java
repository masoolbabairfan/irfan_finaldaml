...
public class MetaData0 {
  ...
  public static MetaData0 fromValue(Value value$) throws IllegalArgumentException {
    ...
    return new com.digitalasset.damlpoc.model.da.generics.MetaData0(name, module_, package$, isNewType);
  }
  ...
  public String toString() {
    return String.format("com.digitalasset.damlpoc.model.da.generics.MetaData0(%s, %s, %s, %s)", this.name, this.module_, this.package$, this.isNewType);
  }
}
